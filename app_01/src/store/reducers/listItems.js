import { ADD_ITEM, DELETE_ITEM, SELECT_ITEM, DESELECT_ITEM } from '../actions/actionTypes'
...
const reducer = (state = initialState, action) => {
    switch(action.type){
        /**
         * ...state entiendalo como azucar sitactico para copiar el old state COMPLETO O DEEP COPY 
         * del estado anterior(que no es ás que un objeto js), recuerde que la inmutbilidad establece que 
         * siempre haga copia de los objetos anteriores, el tema de que consume memoria ciertoo pero ya estamos en 
         * niveles de almacenamiento muy grandes y además eso hace segura la transacción
         */
        case ADD_ITEM:
            return {
                ...state,
        ...
        return {
            ...state,
            selectedItem: state.listItems.find(x => {return x.key === action.keyOut})
        };
