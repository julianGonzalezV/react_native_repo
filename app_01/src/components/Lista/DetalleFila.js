    ...
    render() {            
        ...
        if(this.props.selectedItem){
            modalContent = (
                <View>
                    <Image 
                    source = {this.props.selectedItem? this.props.selectedItem.image: null }
                    style = {styles.imgStyle} />
                    <Text style={styles.itemName}>{this.props.selectedItem.name}</Text>
                </View>
            );            
        }
        //rederItem en FlatList hace referencia al componente que se va a pintar
        return(
            <Modal onRequestClose={this.props.onModalClosed} visible={this.props.selectedItem !== null} animationType="slide">
                <View style = {styles.modalContainer}>
                    {modalContent}
                    <View>
                        <Button title = "borrar" color="red" onPress={this.props.onItemDeleted} />
                        <Button title = "Cerrar" onPress={this.props.onModalClosed}  />
                    </View>
                </View>                
            </Modal>
        );   
